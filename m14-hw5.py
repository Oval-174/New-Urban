#  m14-hw5.py "Регистрация покупателей"
...
button = KeyboardButton(text='Регистрация', callback_data='Регистрация')
...
async def set_age(message, state):
    ...
    crud_functions.add_user(f"{data['username']}", f"{data['email']}", f"{data['age']}")
